...
Se importa la base de datos en un objeto "lapop18".
...
En esta sección usaremos el reporte "El Pulso de la Democracia", disponible [aquí](https://www.vanderbilt.edu/lapop/ab2018/2018-19_AmericasBarometer_Regional_Report_Spanish_W_03.27.20.pdf).
...
ING4.
*Cambiando de nuevo de tema, puede que la democracia tenga problemas, pero es mejor que cualquier otra forma de gobierno. ¿Hasta qué punto está de acuerdo o en desacuerdo con esta frase?*
...
Se guarda la variable recodificada como "lapop18\$ing4rec".
...
También se debe notar que la base de datos en el Environment ahora tiene una variable más, totalizando 85 variables.
...
Con este comando seleccionamos las observaciones de estos países y guardamos esta selección en un nuevo dataframe "lapop2" usando este último comando (adicionalmente se incluye un comentario, que se marca con \#, que incluye la sintaxis si se quisiera hacer con [ ]).
...
El nuevo dataframe "lapop2" tiene 3141 observaciones y 85 variables.
La descripción de la variable "pais" muestra que solio incluye los casos de Honduras (2) y Uruguay (14).
Con esta selección de datos, se puede calcular los porcentajes (frecuencias relativas) usando el comando `prop.table`.
