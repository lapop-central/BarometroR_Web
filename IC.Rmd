...
```{r recodificar satisfaccion, message=FALSE, warning=FALSE}
library(car)
table(lapop18$pn4)
...
```{r ciporgrupo, message=FALSE, warning=FALSE}
library(Rmisc)
...
```{r tolerancia por pais ponderada}
...
```{r grafico tolerancia ponderada}
